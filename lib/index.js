...
class AwesomePermissions {
    ...
    constructor(data) {
        ...
        if (typeof data === 'string' || typeof data === 'undefined') {
            this.#apiUrl = 'https://clients-api.awesomepermissions.com';
            this.#version = 'v1';
            this.#accessKey = data || process.env.AWP_ACCESS_KEY;
            this.#providerIPPrefix = 'https://';
        } else {
            const { apiUrl, developMode, version, accessKey } = data;
            this.#apiUrl = apiUrl ? apiUrl : developMode ? 'http://127.0.0.1:8080' : 'https://clients-api.awesomepermissions.com';
            this.#version = version || 'v1';
            this.#accessKey = accessKey || process.env.AWP_ACCESS_KEY;
     ...
     * });
     * */
    async addPermissionsToGroups({ groups, permissions, actions, ignoreDuplicateErrors = true }) {
        await this.#waitToIp();
